...
import io.github.astraea.spark.smap.SourceDebugCache;
...
public class LegacyFabricSparkMixinPlugin implements IMixinConfigPlugin, IExtension {
    ...
    public void onLoad(String mixinPackage) {
        ...
        if (activeTransformer instanceof IMixinTransformer && ((IMixinTransformer) activeTransformer).getExtensions() instanceof Extensions) {
            Extensions extensions = (Extensions) ((IMixinTransformer) activeTransformer).getExtensions();
            extensions.add(this);
        } else {
            LOGGER.error(
