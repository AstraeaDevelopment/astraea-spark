...
import io.github.astraea.spark.LegacyFabricSparkMod;
import io.github.astraea.spark.LegacyFabricClassSourceLookup;
...
public abstract class LegacyFabricSparkPlugin implements SparkPlugin {

    private final LegacyFabricSparkMod mod;
    private final Logger logger;
    protected final ScheduledExecutorService scheduler;

    protected SparkPlatform platform;

    protected LegacyFabricSparkPlugin(LegacyFabricSparkMod mod) {
        this.mod = mod;
    ...
    public ClassSourceLookup createClassSourceLookup() {
        return new LegacyFabricClassSourceLookup(createClassFinder());
    }
